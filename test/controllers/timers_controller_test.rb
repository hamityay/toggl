...
class TimersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create timer" do
    assert_difference('Timer.count') do
      post timers_url, params: { timer: { finish: @timer.finish, info: @timer.info, start: @timer.start, type_id: @timer.type_id, user_id: @timer.user_id } }
    end
  ...
  test "should update timer" do
    patch timer_url(@timer), params: { timer: { finish: @timer.finish, info: @timer.info, start: @timer.start, type_id: @timer.type_id, user_id: @timer.user_id } }
